...
void message01()
{
    ...
    printf("Message 01:\n");
    displayEnigmaMessage(toString(enigma), MESSAGEFORMAT_WEHRMACHT);
}
...
{
    printf("#####################################################################################\n");
    printf("# ENIGMA CHALLENGE  - MESSAGE 10 - Just cipher - Step 1\n");
    printf("#####################################################################################\n");
    IocRecipe recipe;
...
{
    printf("#####################################################################################\n");
    printf("# ENIGMA CHALLENGE  - MESSAGE 10 - Just cipher - Step 1 LIMITED\n");
    printf("#####################################################################################\n");
...
{
    printf("#####################################################################################\n");
    printf("# ENIGMA CHALLENGE  - MESSAGE 10 - Just cipher - Step 2\n");
    printf("#####################################################################################\n");
...
{
    printf("#####################################################################################\n");
    printf("# ENIGMA CHALLENGE  - MESSAGE 10 - Just cipher - Experimental\n");
    printf("#####################################################################################\n");
