...
void testEnigmaM4(void)
{
    ...
    encodeDecode(enigma);
    result=toString(enigma);
    assertStringEquals("SFNXFPQKKAISGWNNTBSTLMJOOWMFJXWIMCVRWALUSDDIIVQGXTEOAXZXURQUXPXDKZYNEMDZTDBEUPNKINOJHYUGZTPLKHAAMIZHSIWXGPHPQPTZDNBCFQDWACPFTXJKWVZGIFVBJYIAWFNXIWDIOXLAZDOXHNAPZXPSSJQSTTHKAIDMSCCNSBLYDLBOLRQNDZUO", result);
